<template>
    ...
    <section class="py-24">
        <div class="container">
            ...
            <h4 class="mt-5">3. Information Collection and Use</h4>

            <p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>

            <h4 class="mt-5">4. Types of Data Collected</h4>
            ...
            <h4 class="mt-5">6. Retention of Data</h4>
            ...
            <h4 class="mt-5">7. Transfer of Data</h4>
            ...
            <p><strong><strong></strong></strong> will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

            <h4 class="mt-5">8. Disclosure of Data</h4>

            <p><strong>We may disclose personal information that we collect, or you provide:</strong></p>
            ...
            <ol type="1">
                ...
                <li>
                    <strong>Other cases. We may disclose your information also:</strong><br />
                    <ol type="1">
            ...
            <h4 class="mt-5">9. Security of Data</h4>

            <p>The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
            
            <h4 class="mt-5">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</h4>

            <p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.</p>

            <p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>

            <p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at solutions@gocloud.asia.</p>
            ...
            <h4 class="mt-5">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</h4>
            ...
            <ol type="1">
                ...
                <li>users are able to change their personal information by emailing us at solutions@gocloud.asia.</li>
            </ol>
            ...
            <h4 class="mt-5">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</h4>
            ...
            <p><strong>To exercise your data protection rights, you can make certain requests and ask us:</strong></p>
            
            <ol type="1">
                <li>What personal information we have about you. If you make this request, we will return to you:<br />
                    <ol type="1">
            ...
            <p>To exercise your California data protection rights described above, please send your request(s) by email: solutions@gocloud.asia.</p>

            <p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.</p>

            <h4 class="mt-5">13. Service Providers</h4>
            ...
            <h4 class="mt-5">14. Analytics</h4>

            <p>We may use third-party Service Providers to monitor and analyze the use of our Service.</p>

            <h4 class="mt-5">15. CI/CD tools</h4>

            <p>We may use third-party Service Providers to automate the development process of our Service.</p>

            <h4 class="mt-5">16. Behavioral Remarketing</h4>

            <p>We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.</p>

            <h4 class="mt-5">17. Payments</h4>
            ...
            <h4 class="mt-5">18. Links to Other Sites</h4>

            <p>Our Service may contain links to other sites that are not operated by us. If you click a third party link, you will be directed to that third party’s site. We strongly advise you to review the Privacy Policy of every site you visit.</p>

            <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

            <h4 class="mt-5">19. Children’s Privacy</h4>
            ...
            <h4 class="mt-5">20. Changes to This Privacy Policy</h4>
